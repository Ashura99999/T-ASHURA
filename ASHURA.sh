    ...
    figlet TX ASHURA | lolcat

    echo -e  "TOOLS    : ASHURA $white         

    " |lolcat

    echo -e  "By  : ASHURA_CYBER_ARMY $green   " |lolcat

    echo -e  "Blog  : ASHURA_CYBER_ARMY.com 
    ...
    echo -e $white"[#]> terima kasih sudah mampir :).."
    ...
    echo -e $g "6.  HiddenEye${endc}";

    echo -e "============================" | lolcat 

    echo -e $b "7.  evillimiter${endc}";
    ...
    echo -e "${y} Installer HiddenEye..."

    echo -e "${y} cd HiddenEye"

    echo -e "${y} python3 HiddenEye.py"
    ...
    echo -e "${y} Installer evillimiter..."

    echo -e "${y} cd evillimiter"

    echo -e "${y} evillimiter"

    
    ;;
 

    8) echo "created by : ashura_cyber_army" | lolcat
